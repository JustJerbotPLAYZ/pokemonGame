...
public enum PokemonType {
	...
	static {
		...
		BUG.typeAttacks.addAll(Arrays.asList(new Attack("Bug Bite", 10, 100), new Attack("Pin Missile", 25, 100),
				new Attack("Twineedle", 25, 100), new Attack("Leech Life", 80, 100)));

		NORMAL.typeAttacks
				.addAll(Arrays.asList(new Attack("Quick attack", 40, 100), new Attack("Fury attack", 15, 100)));

		FIRE.typeAttacks.addAll(Arrays.asList(new Attack("Flamethrower", 90, 100), new Attack("Fire Spin", 35, 100),
				new Attack("Fire Blast", 110, 100), new Attack("Ember", 40, 100)));

		WATER.typeAttacks.addAll(Arrays.asList(new Attack("Bubble", 40, 100), new Attack("Hydro Pump", 110, 100),
				new Attack("Water Gun", 40, 100)));

		GRASS.typeAttacks.addAll(Arrays.asList(new Attack("Petal Dance", 120, 100), new Attack("Vine Whip", 45, 100),
				new Attack("Solar Beam", 120, 100)));

		ROCK.typeAttacks.addAll(Arrays.asList(new Attack("Rock Slide", 75, 100), new Attack("Rock Throw", 50, 100)));

		GROUND.typeAttacks.addAll(Arrays.asList(new Attack("Dig", 80, 100), new Attack("Earthquake", 100, 100),
				new Attack("Bone Club", 65, 100)));

		ICE.typeAttacks.addAll(Arrays.asList(new Attack("Blizzard", 110, 100), new Attack("Ice Beam", 90, 100),
				new Attack("Ice Punch", 75, 100)));

		ELECTRIC.typeAttacks.addAll(Arrays.asList(new Attack("Thunder", 110, 100), new Attack("Thunderbolt", 90, 100),
				new Attack("Thunder Punch", 75, 100), new Attack("Thunder Shock", 40, 100)));

		PSYCHIC.typeAttacks.addAll(Arrays.asList(new Attack("Confusion", 50, 100), new Attack("Psybeam", 65, 100),
				new Attack("Psychic", 90, 100)));

		DRAGON.typeAttacks.addAll(Collections.singletonList(new Attack("Dragon Rage", 130, 100)));

		POISON.typeAttacks.addAll(Arrays.asList(new Attack("Acid", 40, 100), new Attack("Poison Sting", 15, 100),
				new Attack("Sludge", 65, 100)));

		FLYING.typeAttacks.addAll(Arrays.asList(new Attack("Gust", 40, 100), new Attack("Sky Attack", 140, 100),
				new Attack("Wing Attack", 60, 100)));

		FIGHTING.typeAttacks.addAll(Arrays.asList(new Attack("Double Kick", 30, 100), new Attack("Submission", 80, 100),
				new Attack("High Jump Kick", 130, 100)));

		GHOST.typeAttacks.addAll(Arrays.asList(new Attack("Lick", 30, 100), new Attack("Night Shade", 65, 100)));
	}
